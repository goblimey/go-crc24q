...
func TestTable(t *testing.T) {
	for i := range table {
		if table[i] != hackageTable[i] {
			t.Fatal("Oh dear")
		}
	}
}

/* This CRC-24Q table was found on hackage here:
// https://hackage.haskell.org/package/rtcm-0.1.5/src/src/Data/CRC24Q.hs
*/
var hackageTable = []uint32{
